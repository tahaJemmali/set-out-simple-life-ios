...
class PersonalDetailsViewController: UIViewController , UITextFieldDelegate{
    ...
    func updateEmailUser(oldEmail:String,newEmail:String,pwd:String)  {
        ...
        SVProgressHUD.show()
        var json: String?
        let parameters: [String: String] = ["oldEmail": oldEmail,"newEmail":newEmail,"password":pwd,"firstName": self.firstName,"lastName":self.lastName,"address":self.address,"phone":self.phone]
